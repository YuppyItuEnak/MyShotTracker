        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="" class="flex ms-2 md:me-24">
                    <h1 class="me-8 text-2xl text-white font-bold">My Shot Tracker</h1>
                </a>
            </div>
                            ...
                            <ul class="py-1" role="none">
                                ...
                                <li>
                                    <form method="POST" action="{{ route('logout') }}" enctype="multipart/form-data"
                                        ...
                                        @method('POST')
                                        @csrf
                                        <button type="submit" name="submit" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
