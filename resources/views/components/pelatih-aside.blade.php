        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('pelatih.index') }}"
                    class="flex items-center p-2 text-white rounded-lg hover:bg-secondary hover:text-grafik group">
                    <svg class=" w-5 h-5 text-white  hover:text-grafik transition duration-75 group-hover:text-grafik" viewBox="0 0 24 24"
